...
#define MAX_TKeyBoard			8				//模拟触摸键盘的个数
...
#define TKEY_BoardParaSetLR		5				//参数输入触摸键盘(带当前值设定键和左右键)
#define TKEY_BoardParaSetLROut	6				//参数输入触摸键盘(带当前值设定键和左右键和输出键)
#define TKEY_BoardAsc			7				//输入触摸键盘(带字符A~F)
#define TKEY_BoardTest			8				//测试触摸键盘(带自动测试)
